    ...
    <section className="flex flex-col md:flex-row items-center justify-center gap-8 px-6 py-12 shadow">
      ...
      <div className="flex-1 flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex flex-col gap-4 w-full max-w-sm">
          ...
          <button
            onClick={() => router.push("/signup")}
            className="w-full py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-md 
          ...
          <button
            onClick={() => router.push("/login")}
            className="w-full py-3 border border-green-700 text-green-700 font-semibold rounded-md 
                       hover:bg-green-100 transition-all duration-300 transform hover:scale-105 active:scale-95 cursor-pointer"
          >
            Zaloguj się
          </button>
        </div>
